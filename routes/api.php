...
Route::post('login-user', [AuthenticatedSessionController::class, 'login_user']);// need a check
...
Route::get('view-favorite-books/{userId}', [UserController::class, 'view_Favorite_Books']);// retryyyy
...
// Route::middleware(['auth:sanctum','author'])->group(function(){
    Route::post('publish-book', [AuthorController::class, 'publish_Book']);//need a check
